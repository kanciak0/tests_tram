...
def serial_service():
    service = SerialService(config_file='../common/config_file.txt')
    yield service
    service.close()


@pytest.mark.skip("Configuration not working")
def test_uplink1_rs485_custom(serial_service):
    """
...
def test_uplink1_rs232_custom_speed(serial_service):
    """
...
def test_uplink1_rs232_custom_framing(serial_service):
