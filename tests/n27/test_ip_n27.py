...
def serial_service(request):
    ...
    service = SerialService(config_file=config_file, test_file_name="log_test_ip_n27")
    yield service
    service.close()


def test_ip_iface_n27(serial_service):
...
def test_ip_ping_n27(serial_service, address="8.8.8.8"):
...
@pytest.mark.skip(reason="Deprecated for this firmware version.")
def test_server_ip2_n27(serial_service, server_ip2="192.168.1.2"):
...
@pytest.mark.skip(reason="Deprecated for this firmware version.")
def test_failure_action_n27(serial_service, action="prev-config"):
...
@pytest.mark.skip(reason="Deprecated for this firmware version.")
def test_testing_interval_n27(serial_service, interval=120):
...
@pytest.mark.skip(reason="Deprecated for this firmware version.")
def test_ping_size_n27(serial_service, size=64):
...
@pytest.mark.skip(reason="Deprecated for this firmware version.")
def test_ping_count_n27(serial_service, count=3):
...
@pytest.mark.skip(reason="Deprecated for this firmware version.")
def test_ping_tout_n27(serial_service, timeout=1000):
